...
const Cart = () => {
  ...
  return (
    <div className="bg-half-transparent w-auto rounded-xl fixed nav-item top-16 right-0 drop-shadow-md overflow-x-scroll">
      <div className="float-right h-screen overflow-y-auto rounded-lg duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8">
